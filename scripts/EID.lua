...
TornPageDesc["spa"] = {
	[-1] = "<Libro de mod, no tiene función>", --Modded books
...
if true then
	...
	EID:addCollectible(CustomCollectibles.ORDINARY_LIFE, "{{ArrowUp}} {{Tears}} Más lágrimas #{{TreasureRoom}} Genera un objeto relacionado a Mamá o Papá en la Sala del tesoro junto al objeto regular; sólo puedes tomar uno", "Vida ordinaria", "spa")	
	EID:addCollectible(CustomCollectibles.COOKIE_CUTTER, "Te otorga un {{Heart}} un contenedor de corazón y un {{BrokenHeart}} corazón roto#{{Warning}} ¡Tener 12 corazones te matará!", "Cortador de Galletas", "spa")
	EID:addCollectible(CustomCollectibles.SINNERS_HEART, "{{ArrowUp}} {{Damage}} Daño +2, multiplicador de daño x1.5#{{ArrowDown}} baja la velocidad de tiro#lágrimas teledirigidas", "Corazón de los Pecadores", "spa")
	...
	EID:addCollectible(CustomCollectibles.MAGIC_PEN, "Las lágrimas dejan {{ColorRainbow}}creep arcoíris{{CR}} bajo ellas #Efectos de estado permantenes se aplican a los enemigos que caminen por el creep", "Pluma Mágica", "spa")
	...
	EID:addCollectible(CustomCollectibles.CHERUBIM, "{{Collectible331}} Un familiar que lanza lágrimas de Divinidad a una cadencia de tiro alta", "Bebé Zen", "spa")
	...
	EID:addCollectible(CustomCollectibles.QUASAR, "{{Collectible712}} Consume todos los objetos en pedestal y otorga 3 flamas de Lemegeton", "Quasar", "spa")
	EID:addCollectible(CustomCollectibles.TWO_PLUS_ONE, "{{Shop}} Cada tercer objeto comprado en la tienda del piso actual costará 1 moneda#Comprar 2 objetos con corazones en una habitación hará que los demás se vuelvan gratuitos", "2+1", "spa")
	...
	EID:addCollectible(CustomCollectibles.CHEESE_GRATER, "Remueve un contenedor de corazón#Otorga: #{{ArrowUp}} {{Damage}} Daño +0.5#Dos mini-Isaacs", "Rayador de Queso", "spa")
	...
	EID:addCollectible(CustomCollectibles.GUSTY_BLOOD, "{{ArrowUp}} Matar a los enemigos te da más {{Tears}} lágrimas y {{Speed}} velocidad #Se resetea al entrar a una nueva habitación", "Sangre Tempestuosa", "spa")
    ...
    EID:addCollectible(CustomCollectibles.ULTRA_FLESH_KID, "Familiar que persigue y ataca a los enemigos, posee 3 fases#{{Heart}} Conseguir corazones rojos hará que evolucione#{{Heart}} Se necesitan 15 corazones en total para hacerlo evolucionar", "Chico Ultra-carnoso", "spa")
	...
	EID:addCollectible(CustomCollectibles.BOOK_OF_JUDGES, "Se generarán punteros al entrar a una sala con enemigos#Cada 3 segundos, caerán rayos de luz sobre estos punteros#{{Burning}} Los rayos dañan y queman a los enemigos, pero también te pueden dañar, but they hurt you too#Usar el libro anulará el efecto durante la sala")
	EID:addCollectible(CustomCollectibles.BIRTH_CERTIFICATE, "{{Warning}} DE UN SOLO USO#Consumirá todos los trinkets que poseas#Te teletransportarás a una sala especial con demasiados trinkets, junto a otros recolectables#Sólo podrás tomar unp; después de esto, serás transportado a la sala donde estabas antes")
	...
	EID:addTrinket(CustomTrinkets.KEY_TO_THE_HEART, "Al tenerlo, cada enemigo tiene una posibilidad de soltar un Cofre Carnoso al morir#Los Cofres Carnosos contienen: 1-4 {{Heart}}corazones/{{Pill}}píldoras O un objeto aleatorio relativo al cuerpo", "Llave al Corazón", "spa")
	...
	EID:addTrinket(CustomTrinkets.MAGIC_SWORD, "{{ArrowUp}} {{Damage}} x2 de daño al sostenerlo#Se rompe al recibir daño#{{ArrowUp}}Tener Cinta Adhesiva evitará que se rompa", "Espada Mágica", "spa")
	...
	EID:addTrinket(CustomTrinkets.KEY_KNIFE, "{{Collectible705}} 5% de posibilidad de activar el efecto de Artes Oscuras al recibir daño Dark Arts#{{DevilRoom}} Aumenta la posibilidad de aparición de cofres negros en las Salas del diablo", "Llave cuchillo", "spa")
	...
	-- Píldoras
	EID:addPill(CustomPills.ESTROGEN, "{{Heart}} Convierte todos tus corazones en Coágulos#Te deja con al menos un corazón rojo, No afecta {{SoulHeart}} Corazones de Alma ni {{BlackHeart}} Corazones Negros", "Estrógeno", "spa")
	EID:addPill(CustomPills.LAXATIVE, "{{Collectible680}} Hace que dispares los maíces de Venganza de Montezuma durante 3 segundos", "Laxante", "spa")
	EID:addPill(CustomPills.PHANTOM_PAINS, "Provoca que Isaac reciba daño falso al usarse, luego a los 20 y 40 segundos de haberla consumido", "Dolores fantasma", "spa")
	EID:addPill(CustomPills.YUCK, "Genera un corazón podrido #Por 30 segundos, cada corazón rojo tomado generará moscas azules", "Iugh", "spa")
